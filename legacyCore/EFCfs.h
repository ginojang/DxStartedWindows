...
#define __EFC_FILE_HEADER__
	...
	extern void EFC_fsInitialize( void );
	extern void EFC_fsFinalize( void );
	...
	//extern LPEXBUFF EFC_fsLoadRES( schar *pszRes );
	...
	// 추가다운로드시 사용
	extern void EFC_fsLoadLIST( void );
	extern void EFC_fsFreeLIST( void );
	extern sint32 EFC_fsGetLIST( schar *pszFile );
	extern ubool EFC_fsLoadDATA( void );
	extern void EFC_fsFreeDATA( void );
	extern LPEXBUFF EFC_fsGetDATA( schar *pszFile );
